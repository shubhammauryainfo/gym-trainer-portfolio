...
const ContactSection = () => {
  const [formData, setFormData] = useState({
    ...
    subject: '',
    message: '',
    site: '' // Added new field 'site' but not shown in the form
  });
          ...
          <div>
            ...
            <div className="bg-fitness-red p-8 rounded-lg">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/sami_17s_/" className="h-12 w-12 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/30 transition-colors">
                ...
                <a href="https://www.youtube.com/@Sami_17s_" className="h-12 w-12 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/30 transition-colors">
                  <svg className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
